...
public class ProtocolThread implements Callable<Object[]> {
	...
	public Object[] call() throws Exception {
		key = currentNode.Identifier(1) != null?currentNode.Identifier(1).getText():currentNode;
		...
		try {
			...
			Object addr=(currentNode.Identifier(0)!=null)?runner.visit(currentNode.Identifier(0)):currentNode.protocol().getText();
